                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="logo-tab" data-toggle="tab" href="#themeColorTab" role="tab" aria-controls="themeColorTab" aria-selected="true">{{__('admin.Theme Color')}}</a>
                                        </li>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-theme-color') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="cookie_text">{{__('admin.Primary Background')}}</label>
                                                                <input type="color" value="{{ $setting->theme_one_color }}" name="theme_one_color" class="form-control">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="cookie_text">{{__('admin.Primary Foregorund')}}</label>
                                                                <input type="color" value="{{ $setting->theme_two_color }}" name="theme_two_color" class="form-control">
                                                            </div>
