...
<title><?php echo e(__('admin.Admin Language')); ?></title>
        ...
        <div class="section-body">
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo e(route('admin.update-admin-language')); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\testing\complete_game_topup\pak_game\resources\views/admin/admin_language.blade.php ENDPATH**/ ?>