...
<title><?php echo e(__('admin.Create currency')); ?></title>
                        ...
                        <form action="<?php echo e(route('admin.currency.store')); ?>" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <input class="form-control" type="text" name="currency_name" value="<?php echo e(old('currency_name')); ?>">
                                </div>
                                <div class="form-group col-12">
                                    <label><?php echo e(__('admin.Country Code')); ?> <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="country_code" value="<?php echo e(old('country_code')); ?>">
                                </div>
                                <div class="form-group col-12">
                                    <label><?php echo e(__('admin.Currency Code')); ?> <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="currency_code" value="<?php echo e(old('currency_code')); ?>">
                                </div>
                                <div class="form-group col-12">
                                    <label><?php echo e(__('admin.Currency Icon')); ?> <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="currency_icon" value="<?php echo e(old('currency_icon')); ?>">
                                </div>

                                <div class="form-group col-12">
                                    <label><?php echo e(__('admin.Currency Rate')); ?> <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="currency_rate" value="<?php echo e(old('currency_rate')); ?>">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select name="currency_position" class="form-control">
                                        <option value="left"><?php echo e(__('admin.Before Price')); ?></option>
                                        <option value="right"><?php echo e(__('admin.After Price')); ?></option>
                                    </select>
                                </div>
                                <div class="form-group col-12">
...
<?php echo $__env->make('admin.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\testing\complete_game_topup\pak_game\resources\views/admin/create_currency.blade.php ENDPATH**/ ?>