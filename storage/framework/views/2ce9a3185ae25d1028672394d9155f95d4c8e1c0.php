        ...
        <div class="row mt-5">
            ...
            <div class="col-md-3">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                    <div class="card-header">
                        <h4><?php echo e(__('admin.Complete Withdraw')); ?></h4>
                    </div>
                    <div class="card-body">
                        <?php echo e($setting->currency_icon); ?><?php echo e($complete_withdraw); ?>
            ...
            <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <div class="card-header-action">
                        <a href="<?php echo e(route('seller.all-booking')); ?>" class="btn btn-danger"><?php echo e(__('admin.View More')); ?> <i class="fas fa-chevron-right"></i></a>
                      </div>
                    </div>
...
<?php echo $__env->make('seller.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\testing\complete_game_topup\pak_game\resources\views/seller/dashboard.blade.php ENDPATH**/ ?>