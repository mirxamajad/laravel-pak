        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="<?php echo e(route('seller.dashboard')); ?>"><?php echo e(__('admin.Dashboard')); ?></a></div>
              <div class="breadcrumb-item"><?php echo e(__('admin.Products')); ?></div>
            </div>
          </div>

          <div class="section-body">
            <a href="<?php echo e(route('seller.product.create')); ?>" class="btn btn-primary"><i class="fas fa-plus"></i> <?php echo e(__('admin.Add New')); ?></a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(route('seller.product.edit',['product' => $product->id, 'lang_code' => 'en'])); ?>"><?php echo e(html_decode($product->productlangadmin->name)); ?></a></td>
                                        <?php
                                        ...
                                        <td>
                                        <a href="<?php echo e(route('seller.product.edit',['product' => $product->id, 'lang_code' => 'en'])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        <?php
...
<script>
    ...
    function deleteData(id){
        $("#deleteForm").attr("action",'<?php echo e(url("seller/product/")); ?>'+"/"+id)
    }
...
<?php echo $__env->make('seller.master_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\testing\complete_game_topup\pak_game\resources\views/seller/product.blade.php ENDPATH**/ ?>