...
<body>
  <div id="app">
    <div class="main-wrapper">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?php echo e(route('seller.edit-profile')); ?>" class="dropdown-item has-icon">
                <i class="far fa-user"></i> <?php echo e(__('admin.Profile')); ?>

              </a>
              <div class="dropdown-divider"></div>
              <a href="<?php echo e(route('seller.logout')); ?>" class="dropdown-item has-icon text-danger" onclick="event.preventDefault();
              document.getElementById('admin-logout-form').submit();">
                <i class="fas fa-sign-out-alt"></i> <?php echo e(__('admin.Logout')); ?>

              </a>
            
            <form id="admin-logout-form" action="<?php echo e(route('seller.logout')); ?>" method="POST" class="d-none">
                <?php echo csrf_field(); ?>
            </form>
      ...
      <?php echo $__env->make('seller.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <footer class="main-footer">
        ...
        <div class="footer-right">
            <?php echo e(__('admin.Current Version')); ?> : <?php echo e($setting->app_version); ?>
...
<?php /**PATH C:\testing\complete_game_topup\pak_game\resources\views/seller/master_layout.blade.php ENDPATH**/ ?>